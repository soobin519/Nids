 ...
 */
@Controller
@RequestMapping("/JusoMobilePopup")
public class JusoMobilePopupController{

    private final String siteName;


    public JusoMobilePopupController(final String siteName) {
    ...
    public ModelAndView doPopup() {
        ...
        ModelAndView mav = new ModelAndView("jusoMobilePopup");
