...
@EnableWebMvc
@Configuration
@ComponentScan( basePackages = {"com.aws.codestar.projecttemplates.dao", "com.aws.codestar.projecttemplates.services"})
@Import({ ApplicationConfig.class, DataConfig.class })
