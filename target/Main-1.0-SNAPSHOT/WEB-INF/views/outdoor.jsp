...
<head>
    ...
    <style>
     ...
     <!-- <style>
        ...
        #indoor{ background-color: rgb(59,201,140);}
        #outdoor{ background-color: rgb(159,60,90);}
    </style> -->
</head>
...
<h1 id="p_title">실외 미세먼지 현황</h1>
    ...
    <!-- <form action="/", method="post">
        <ul>
            <li>위도:<span id="lat" name ="lat"></span></li>
            <li>경도:<span id="lon" name="lon"></span></li>
        </ul>
    </form> -->
    <br>
